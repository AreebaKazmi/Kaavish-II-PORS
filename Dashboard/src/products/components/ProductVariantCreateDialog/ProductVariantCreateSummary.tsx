...
import { ProductVariantBulkCreate_productVariantBulkCreate_bulkProductErrors } from "@Kaavish/products/types/ProductVariantBulkCreate";
import { ProductVariantBulkCreateInput } from "@Kaavish/types/globalTypes";
