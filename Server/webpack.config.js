...
module.exports = (_, argv) => {
  ...
  if (!devMode) {
    ...
    output = {
      path: resolve('kaavish/static/assets/'),
  ...
  return {
    entry: {
      dashboard: './kaavish/static/dashboard/js/dashboard.js',
      document: './kaavish/static/dashboard/js/document.js',
      storefront: './kaavish/static/js/storefront.js'
    },
    output: output,
    module: {
      rules: [
        ...
        },
        {
          ...
          include: [
            ...
            resolve('kaavish/static/fonts'),
            resolve('kaavish/static/images'),
            resolve('kaavish/static/dashboard/images')
          ]
        }
      ]
    },
