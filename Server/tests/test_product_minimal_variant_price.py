...
from kaavish.discount import DiscountValueType
from kaavish.product.models import Product, ProductVariant
from kaavish.product.tasks import (
    update_all_products_minimal_variant_prices_task,
    update_products_minimal_variant_prices_of_catalogues,
)
from kaavish.product.utils.variant_prices import update_product_minimal_variant_price
...
@patch(
    "kaavish.product.management.commands"
