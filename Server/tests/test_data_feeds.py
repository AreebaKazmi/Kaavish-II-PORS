...
from kaavish.data_feeds.google_merchant import (
    get_feed_items,
    item_attributes,
    item_google_product_category,
    write_feed,
)
from kaavish.product.models import AttributeValue, Category


def test_kaavish_feed_items(product, site_settings):
...
@patch("kaavish.data_feeds.google_merchant.item_link")
