...
from kaavish.extensions.checks import check_extensions


@pytest.mark.parametrize(
    "manager_path", [None, "", "kaavish.core.extension.wrong_path.Manager"]
)
...
@pytest.mark.parametrize(
    "plugin_path", [None, "", "kaavish.core.extension.wrong_path.Plugin"]
)
