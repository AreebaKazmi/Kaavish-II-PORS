...
from kaavish.account import forms, i18n
from kaavish.account.forms import FormWithReCaptcha, NameForm
from kaavish.account.models import User
from kaavish.account.templatetags.i18n_address_tags import format_address
from kaavish.account.utils import (
    get_random_avatar,
    get_user_first_name,
    get_user_last_name,
)
from kaavish.account.validators import validate_possible_number
...
@patch("kaavish.account.views.send_account_delete_confirmation_email")
