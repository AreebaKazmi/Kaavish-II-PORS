...
import kaavish.account.emails as account_emails
import kaavish.order.emails as emails
from kaavish.core.emails import get_email_context
from kaavish.core.utils import build_absolute_uri
from kaavish.order.utils import add_variant_to_order
...
@mock.patch("kaavish.order.emails.send_templated_mail")
