...
from kaavish.payment.gateways.stripe import (
    TransactionKind,
    _get_client,
    authorize,
    capture,
...
from kaavish.payment.interface import CreditCardInfo, CustomerSource, GatewayConfig
...
def test_get_plugin_configuration_hides_all_stripe_secrets(settings):
    settings.PLUGINS = ["kaavish.payment.gateways.stripe.plugin.StripeGatewayPlugin"]
