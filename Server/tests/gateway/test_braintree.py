...
from kaavish.payment.gateways.braintree import (
    TransactionKind,
    authorize,
    capture,
    create_form,
...
from kaavish.payment.gateways.braintree.errors import (
    DEFAULT_ERROR_MESSAGE,
    BraintreeException,
)
from kaavish.payment.gateways.braintree.forms import BraintreePaymentForm
from kaavish.payment.interface import (
    CreditCardInfo,
    CustomerSource,
    GatewayConfig,
    TokenConfig,
)
from kaavish.payment.utils import create_payment_information
...
def test_get_error_for_client(braintree_error, monkeypatch):
    ...
    monkeypatch.setattr("kaavish.payment.gateways.braintree.ERROR_CODES_WHITELIST", {})
    assert get_error_for_client([error]) == DEFAULT_ERROR

    monkeypatch.setattr(
        "kaavish.payment.gateways.braintree.ERROR_CODES_WHITELIST",
...
@patch("kaavish.payment.gateways.braintree.get_braintree_gateway")
