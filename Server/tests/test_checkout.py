...
from kaavish.account import CustomerEvents
from kaavish.account.models import Address, CustomerEvent, User
from kaavish.account.utils import store_user_address
from kaavish.checkout import AddressType, views
from kaavish.checkout.forms import CheckoutVoucherForm, CountryForm
from kaavish.checkout.utils import (
...
from kaavish.core.exceptions import InsufficientStock
from kaavish.core.taxes import zero_money, zero_taxed_money
from kaavish.discount import DiscountValueType, VoucherType
from kaavish.discount.models import NotApplicable, Voucher
from kaavish.extensions.manager import ExtensionsManager, get_extensions_manager
from kaavish.order import OrderEvents, OrderEventsEmails
from kaavish.order.models import OrderEvent
from kaavish.shipping.models import ShippingZone
...
def test_view_checkout_index(
    ...
    monkeypatch.setattr(
        "kaavish.checkout.utils.get_checkout_from_request", lambda req, qs: checkout
    )
...
@patch("kaavish.checkout.utils.send_order_confirmation")
...
@patch("kaavish.discount.utils.validate_voucher")
...
def test_get_discount_for_checkout_specific_products_voucher_not_applicable(
    ...
    discounts = []
    monkeypatch.setattr(
        "kaavish.checkout.utils.get_prices_of_discounted_specific_product",
