...
from kaavish.menu.models import MenuItemTranslation
from kaavish.menu.utils import update_menu
from kaavish.product import AttributeInputType, ProductAvailabilityStatus, models
from kaavish.product.filters import filter_products_by_attributes_values
...
from kaavish.product.thumbnails import create_product_thumbnails
from kaavish.product.utils import (
    allocate_stock,
    deallocate_stock,
    decrease_stock,
    increase_stock,
...
from kaavish.product.utils.availability import get_product_availability_status
from kaavish.product.utils.costs import get_margin_for_variant
from kaavish.product.utils.digital_products import increment_download_count
from kaavish.product.utils.variants_picker import get_variant_picker_data
...
@patch("kaavish.product.thumbnails.create_thumbnails")
