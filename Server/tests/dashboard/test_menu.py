...
from kaavish.dashboard.menu.forms import AssignMenuForm
from kaavish.menu.models import Menu, MenuItem, MenuItemTranslation
from kaavish.menu.utils import (
    get_menu_as_json,
