...
from kaavish.dashboard.order.forms import ChangeQuantityForm
from kaavish.dashboard.order.utils import (
    remove_customer_from_order,
    save_address_in_order,
    update_order_with_user_addresses,
)
from kaavish.dashboard.templatetags.orders import display_order_event
from kaavish.discount.utils import increase_voucher_usage
from kaavish.order import FulfillmentStatus, OrderStatus
from kaavish.order.emails import send_fulfillment_confirmation_to_customer
from kaavish.order.events import OrderEvents, OrderEventsEmails
from kaavish.order.models import Order, OrderEvent, OrderLine
from kaavish.order.utils import add_variant_to_order, change_order_line_quantity
from kaavish.payment import ChargeStatus, TransactionKind
from kaavish.product.models import ProductVariant
...
@patch("kaavish.order.actions.emails.send_fulfillment_confirmation")
...
@patch("kaavish.order.actions.send_fulfillment_confirmation_to_customer")
