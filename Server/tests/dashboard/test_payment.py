...
from kaavish.dashboard.forms import ConfigBooleanField, ConfigCharField
from kaavish.dashboard.payment.forms import (
    GatewayConfigurationForm,
    create_custom_form_field,
)
from kaavish.extensions.models import PluginConfiguration
from kaavish.payment.gateways.braintree.plugin import BraintreeGatewayPlugin
...
def test_config_boolean_field_returned_value():
    config_boolean_structure = {
        ...
        "value": True,
        "type": "Boolean",
        "help_text": "Determines if kaavish should enforce 3D secure during payment.",
