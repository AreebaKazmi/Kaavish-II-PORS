...
from kaavish.dashboard.collection.forms import CollectionForm
from kaavish.product.models import Collection
...
def test_collection_create_view(monkeypatch, admin_client):
    ...
    monkeypatch.setattr(
        (
            "kaavish.dashboard.collection.forms."
...
@mock.patch("kaavish.dashboard.collection.views.get_menus_that_need_update")
@mock.patch("kaavish.dashboard.collection.views.update_menus")
