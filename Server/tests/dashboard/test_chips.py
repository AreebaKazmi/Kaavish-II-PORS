...
from kaavish.dashboard.templatetags.chips import (
    CHIPS_PATTERN,
    handle_default,
...
from kaavish.dashboard.widgets import MoneyRangeWidget
from kaavish.product.models import Category, Product
