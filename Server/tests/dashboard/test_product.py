...
from kaavish.dashboard.product import ProductBulkAction
from kaavish.dashboard.product.forms import ProductForm, ProductVariantForm
from kaavish.extensions.manager import get_extensions_manager
from kaavish.product.forms import VariantChoiceField
...
@mock.patch(
    "kaavish.extensions.manager.ExtensionsManager.assign_tax_code_to_object_meta"
)
...
def mocked_tax_types():
    ...
    with mock.patch("kaavish.extensions.manager.ExtensionsManager") as mocked_manager:
...
def test_view_product_image_create(monkeypatch, admin_client, product_with_image):
    ...
    monkeypatch.setattr(
        "kaavish.dashboard.product.forms.create_product_thumbnails.delay",
