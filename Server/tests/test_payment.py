...
from kaavish.payment.interface import CreditCardInfo, GatewayConfig, GatewayResponse
from kaavish.payment.models import Payment
from kaavish.payment.utils import (
...
@patch("kaavish.order.actions.handle_fully_paid_order")
