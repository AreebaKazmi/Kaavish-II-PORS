...
from kaavish.core.taxes import TaxType
from kaavish.extensions.manager import ExtensionsManager
from kaavish.graphql.core.enums import ReportingPeriod
from kaavish.graphql.product.enums import StockAvailability
from kaavish.product import AttributeInputType
from kaavish.product.error_codes import ProductErrorCode
...
from kaavish.product.tasks import update_variants_names
...
def test_product_query(staff_api_client, product, permission_manage_products):
    ...
    from kaavish.product.utils.costs import get_product_costs_data
...
def test_product_image_create_mutation(
    ...
    monkeypatch.setattr(
        (
            "kaavish.graphql.product.mutations.products."
...
@patch("kaavish.product.tasks.update_variants_names.delay")
...
@patch("kaavish.product.tasks._update_variants_names")
