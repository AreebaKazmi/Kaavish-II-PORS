...
from kaavish.account import events as account_events
from kaavish.account.error_codes import AccountErrorCode
from kaavish.account.models import Address, User
from kaavish.account.utils import get_random_avatar
from kaavish.checkout import AddressType
from kaavish.graphql.account.mutations.base import INVALID_TOKEN
from kaavish.graphql.account.mutations.staff import (
    CustomerDelete,
    StaffDelete,
    StaffUpdate,
    UserDelete,
)
from kaavish.graphql.core.enums import PermissionEnum
from kaavish.graphql.core.utils import str_to_enum
from kaavish.order.models import FulfillmentStatus, Order
...
@patch("kaavish.dashboard.emails._send_set_password_email")
...
@patch("kaavish.dashboard.emails._send_set_user_password_email_with_url.delay")
...
@patch("kaavish.account.emails._send_delete_confirmation_email")
...
@patch("kaavish.account.emails._send_account_delete_confirmation_email_with_url.delay")
...
@patch(
    "kaavish.graphql.account.utils.account_events.staff_user_deleted_a_customer_event"
)
...
@patch("kaavish.graphql.account.mutations.staff.get_random_avatar")
...
@patch("kaavish.account.emails._send_user_password_reset_email.delay")
...
@patch("kaavish.account.emails._send_password_reset_email")
...
def test_user_avatar_update_mutation(monkeypatch, staff_api_client, media_root):
    ...
    monkeypatch.setattr(
        (
            "kaavish.graphql.account.mutations.staff."
