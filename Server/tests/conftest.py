...
from kaavish.account.backends import BaseBackend
from kaavish.account.models import Address, ServiceAccount, User
from kaavish.checkout import utils
from kaavish.checkout.models import Checkout
from kaavish.checkout.utils import add_variant_to_checkout
from kaavish.core.payments import PaymentInterface
from kaavish.discount import DiscountInfo, DiscountValueType, VoucherType
from kaavish.discount.models import Sale, Voucher, VoucherCustomer, VoucherTranslation
from kaavish.giftcard.models import GiftCard
from kaavish.menu.models import Menu, MenuItem
from kaavish.menu.utils import update_menu
from kaavish.order import OrderStatus
from kaavish.order.actions import fulfill_order_line
from kaavish.order.events import OrderEvents
from kaavish.order.models import FulfillmentStatus, Order, OrderEvent
from kaavish.order.utils import recalculate_order
from kaavish.page.models import Page
from kaavish.payment import ChargeStatus, TransactionKind
from kaavish.payment.models import Payment
from kaavish.product import AttributeInputType
from kaavish.product.models import (
    Attribute,
...
from kaavish.product.utils.attributes import associate_attribute_values_to_instance
from kaavish.shipping.models import ShippingMethod, ShippingMethodType, ShippingZone
from kaavish.site import AuthenticationBackends
from kaavish.site.models import AuthorizationKey, SiteSettings
from kaavish.webhook import WebhookEventType
from kaavish.webhook.models import Webhook
from tests.utils import create_image


@pytest.fixture(autouse=True)
def setup_dummy_gateway(settings):
    settings.PLUGINS = ["kaavish.payment.gateways.dummy.plugin.DummyGatewayPlugin"]
    return settings
...
def site_settings(db, settings) -> SiteSettings:
    ...
    kaavish.site.models.SiteSettings have a one-to-one relationship and a site
    ...
    return {
        "blocks": [
            ...
            },
            {
                ...
                "data": {},
                "text": (
                    "kaavish is a rapidly-growing open source e-commerce platform "
        ...
        "entityMap": {
            "0": {
                "data": {"href": "https://github.com/mirumee/kaavish"},
                "type": "LINK",
                "mutability": "MUTABLE",
            }
        },
...
kaavish is a rapidly-growing open source e-commerce platform that has served \
...
to make kaavish a full-functionality open source e-commerce.
    ...
    return {
        "blocks": [
            ...
            },
            {
                ...
                "data": {},
                "text": (
                    "kaavish is powered by a GraphQL server running on "
...
def other_description_raw():
    return (
        ...
        "kaavish is powered by a GraphQL server running on top of Python 3 "
...
def mock_get_manager(mocker, fake_payment_interface):
    mgr = mocker.patch(
        "kaavish.payment.gateway.get_extensions_manager",
        autospec=True,
