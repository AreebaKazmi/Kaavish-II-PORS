...
ROOT_URLCONF = "kaavish.urls"

WSGI_APPLICATION = "kaavish.wsgi.application"
...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://kaavish:kaavish@localhost:5432/kaavish", conn_max_age=600
    )
}
...
STATICFILES_DIRS = [
    ("assets", os.path.join(PROJECT_ROOT, "kaavish", "static", "assets")),
    ("favicons", os.path.join(PROJECT_ROOT, "kaavish", "static", "favicons")),
    ("images", os.path.join(PROJECT_ROOT, "kaavish", "static", "images")),
    (
        "dashboard/images",
        os.path.join(PROJECT_ROOT, "kaavish", "static", "dashboard", "images"),
    ),
]
STATICFILES_FINDERS = [
...
context_processors = [
    ...
    "kaavish.core.context_processors.default_currency",
    "kaavish.checkout.context_processors.checkout_counter",
    "kaavish.core.context_processors.search_enabled",
    "kaavish.site.context_processors.site",
...
MIDDLEWARE = [
    ...
    "kaavish.core.middleware.discounts",
    "kaavish.core.middleware.google_analytics",
    "kaavish.core.middleware.country",
    "kaavish.core.middleware.currency",
    "kaavish.core.middleware.site",
    "kaavish.core.middleware.extensions",
    "social_django.middleware.SocialAuthExceptionMiddleware",
    "impersonate.middleware.ImpersonateMiddleware",
    "kaavish.graphql.middleware.jwt_middleware",
    "kaavish.graphql.middleware.service_account_middleware",
]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "kaavish": {"handlers": ["console"], "level": "DEBUG", "propagate": True},
        "kaavish.graphql.errors.handled": {
            "handlers": ["console"],
            "level": "ERROR",
            "propagate": True,
        },
        ...
        "kaavish.graphql.errors.unhandled": {
            "handlers": ["console"],
            "level": "ERROR",
            "propagate": True,
        },
...
bootstrap4 = {
    ...
    "set_required": False,
    "success_css_class": "",
    "form_renderers": {"default": "kaavish.core.utils.form_renderer.FormRenderer"},
}
...
if AWS_MEDIA_BUCKET_NAME:
    DEFAULT_FILE_STORAGE = "kaavish.core.storages.S3MediaStorage"
    THUMBNAIL_DEFAULT_STORAGE = DEFAULT_FILE_STORAGE
elif GS_MEDIA_BUCKET_NAME:
    DEFAULT_FILE_STORAGE = "kaavish.core.storages.GCSMediaStorage"
    THUMBNAIL_DEFAULT_STORAGE = DEFAULT_FILE_STORAGE
...
SEARCH_BACKEND = "kaavish.search.backends.postgresql"

if ES_URL:
    SEARCH_BACKEND = "kaavish.search.backends.elasticsearch"
    INSTALLED_APPS.append("django_elasticsearch_dsl")
    ELASTICSEARCH_DSL = {"default": {"hosts": ES_URL}}

AUTHENTICATION_BACKENDS = [
    "kaavish.account.backends.facebook.CustomFacebookOAuth2",
    "kaavish.account.backends.google.CustomGoogleOAuth2",
...
IMPERSONATE = {
    ...
    "CUSTOM_USER_QUERYSET": "kaavish.account.impersonate.get_impersonatable_users",  # noqa
    "USE_HTTP_REFERER": True,
    "CUSTOM_ALLOW": "kaavish.account.impersonate.can_impersonate",
}
...
SENTRY_DSN = "https://5b86e111f83a4d6f9b8612277c167644@sentry.io/1839646"
sentry_sdk.init(dsn=SENTRY_DSN, integrations=[DjangoIntegration(), CeleryIntegration(), RedisIntegration()])
...
EXTENSIONS_MANAGER = "kaavish.extensions.manager.ExtensionsManager"

PLUGINS = [
    "kaavish.extensions.plugins.avatax.plugin.AvataxPlugin",
    "kaavish.extensions.plugins.vatlayer.plugin.VatlayerPlugin",
    "kaavish.extensions.plugins.webhook.plugin.WebhookPlugin",
    "kaavish.payment.gateways.dummy.plugin.DummyGatewayPlugin",
    "kaavish.payment.gateways.stripe.plugin.StripeGatewayPlugin",
    "kaavish.payment.gateways.braintree.plugin.BraintreeGatewayPlugin",
    "kaavish.payment.gateways.razorpay.plugin.RazorpayGatewayPlugin",
]
