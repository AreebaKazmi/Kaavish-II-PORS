...
from ...utils.scraper_data import (
...
class Command(BaseCommand):
    help = "Populate database with products from the scraper"
    placeholders_dir = "kaavish/static/scrapers/images/" #remove static/placeholders ki directory
    ...
    def sequence_reset(self):
        """Run a SQL sequence reset on all kaavish.* apps.
    ...
    def handle(self, *args, **options):
        ...
        # Remove create_images arg as it is always false
        ...
        # create_orders() needs to be debugged, currently
        # outputs prefetch error.
