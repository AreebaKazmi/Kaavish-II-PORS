...
class Command(BaseCommand):
    ...
    def warm_products(self):
        # Django's versatile image warmer (https://buildmedia.readthedocs.org/media/pdf/django-versatileimagefield/latest/django-versatileimagefield.pdf)
        # to ensures all thumbnails are created and available at the appropriate URL.
