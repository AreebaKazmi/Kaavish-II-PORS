...
IMAGES_MAPPING = {
    61: ["kaavishdemoproduct_paints_01.png"],
    62: ["kaavishdemoproduct_paints_02.png"],
    63: ["kaavishdemoproduct_paints_03.png"],
    64: ["kaavishdemoproduct_paints_04.png"],
    65: ["kaavishdemoproduct_paints_05.png"],
    71: ["kaavishdemoproduct_fd_juice_06.png"],
    72: ["kaavishdemoproduct_fd_juice_06.png"],  # FIXME inproper image
    73: ["kaavishdemoproduct_fd_juice_05.png"],
    74: ["kaavishdemoproduct_fd_juice_01.png"],
    75: ["kaavishdemoproduct_fd_juice_03.png"],  # FIXME inproper image
    76: ["kaavishdemoproduct_fd_juice_02.png"],  # FIXME inproper image
    77: ["kaavishdemoproduct_fd_juice_03.png"],
    78: ["kaavishdemoproduct_fd_juice_04.png"],
    79: ["kaavishdemoproduct_fd_juice_02.png"],
    81: ["kaavishdemoproduct_wine-red.png"],
    82: ["kaavishdemoproduct_wine-white.png"],
    83: ["kaavishdemoproduct_beer-02_1.png", "kaavishdemoproduct_beer-02_2.png"],
    84: ["kaavishdemoproduct_beer-01_1.png", "kaavishdemoproduct_beer-01_2.png"],
    85: ["kaavishdemoproduct_cuschion01.png"],
    86: ["kaavishdemoproduct_cuschion02.png"],
    87: [
        "kaavishdemoproduct_sneakers_01_1.png",
        "kaavishdemoproduct_sneakers_01_2.png",
        "kaavishdemoproduct_sneakers_01_3.png",
        "kaavishdemoproduct_sneakers_01_4.png",
    ],
    88: [
        "kaavishdemoproduct_sneakers_02_1.png",
        "kaavishdemoproduct_sneakers_02_2.png",
        "kaavishdemoproduct_sneakers_02_3.png",
        "kaavishdemoproduct_sneakers_02_4.png",
    ],
    89: ["kaavishdemoproduct_cl_boot07_1.png", "kaavishdemoproduct_cl_boot07_2.png"],
    107: ["kaavishdemoproduct_cl_polo01.png"],
    108: ["kaavishdemoproduct_cl_polo02.png"],
    109: ["kaavishdemoproduct_cl_polo03-woman.png"],
    110: ["kaavishdemoproduct_cl_polo04-woman.png"],
    111: [
        "kaavishdemoproduct_cl_boot01_1.png",
        "kaavishdemoproduct_cl_boot01_2.png",
        "kaavishdemoproduct_cl_boot01_3.png",
    ],
    112: ["kaavishdemoproduct_cl_boot03_1.png", "kaavishdemoproduct_cl_boot03_2.png"],
    113: ["kaavishdemoproduct_cl_boot06_1.png", "kaavishdemoproduct_cl_boot06_2.png"],
    114: [
        "kaavishdemoproduct_cl_boot06_1.png",
        "kaavishdemoproduct_cl_boot06_2.png",
    ],  # FIXME incorrect image
    115: ["kaavishdemoproduct_cl_bogo01_1.png"],
    116: ["kaavishdemoproduct_cl_bogo02_1.png"],
    117: ["kaavishdemoproduct_cl_bogo03_1.png"],
    118: ["kaavishdemoproduct_cl_bogo04_1.png", "kaavishdemoproduct_cl_bogo04_2.png"],
}
...
def create_products_by_schema(placeholder_dir, create_images):
    path = os.path.join(
        settings.PROJECT_ROOT, "kaavish", "static", "populatedb_data.json"
    )
    with open(path) as f:
...
class kaavishProvider(BaseProvider):
    def money(self):
...
fake.add_provider(kaavishProvider)
...
# fake customers.
@patch("kaavish.order.emails.send_payment_confirmation.delay")
...
def create_page():
    ...
    <p>kaavish is a rapidly-growing open source e-commerce platform that has served
       ...
       to make kaavish a full-functionality open source e-commerce.</p>
    <p><a href="https://github.com/FYP 2020/kaavish">Get kaavish today!</a></p>
    """
    content_json = {
        "blocks": [
            {
            ...
            },
            {
                "key": "",
                "data": {},
                "text": "kaavish is a rapidly-growing open source e-commerce platform "
                ...
                "written in React to make kaavish a full-functionality "
        ...
        "entityMap": {
            "0": {
                "data": {"url": "https://github.com/FYP 2020/kaavish"},
                "type": "LINK",
                "mutability": "MUTABLE",
            }
        },
