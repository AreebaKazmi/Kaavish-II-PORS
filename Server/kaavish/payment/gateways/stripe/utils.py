...
def get_currency_for_stripe(currency):
    """Convert kaavish's currency format to Stripe's currency format.

    Stripe's currency is using lowercase while kaavish is using uppercase.
    """
    return currency.lower()


def get_currency_from_stripe(currency):
    """Convert Stripe's currency format to kaavish's currency format.
