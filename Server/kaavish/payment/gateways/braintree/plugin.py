...
class BraintreeGatewayPlugin(BasePlugin):
    ...
    CONFIG_STRUCTURE = {
        ...
        "Use sandbox": {
            ...
            "help_text": pgettext_lazy(
                "Plugin help text",
                "Determines if kaavish should use Braintree sandbox API.",
            ),
        ...
        "Store customers card": {
            ...
            "help_text": pgettext_lazy(
                "Plugin help text",
                "Determines if kaavish should store cards on payments"
        ...
        "Automatic payment capture": {
            ...
            "help_text": pgettext_lazy(
                "Plugin help text",
                "Determines if kaavish should automaticaly capture payments.",
            ),
        ...
        "Require 3D secure": {
            ...
            "help_text": pgettext_lazy(
                "Plugin help text",
                "Determines if kaavish should enforce 3D secure during payment.",
            ),
