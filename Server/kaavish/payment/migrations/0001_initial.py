            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                kaavish.payment.TransactionError("incorrect_number"),
                                "incorrect_number",
                            ),
                            (
                                kaavish.payment.TransactionError("invalid_number"),
                                "invalid_number",
                            ),
                            (
                                kaavish.payment.TransactionError("incorrect_cvv"),
                                "incorrect_cvv",
                            ),
                            (
                                kaavish.payment.TransactionError("invalid_cvv"),
                                "invalid_cvv",
                            ),
                            (
                                kaavish.payment.TransactionError("incorrect_zip"),
                                "incorrect_zip",
                            ),
                            (
                                kaavish.payment.TransactionError("incorrect_address"),
                                "incorrect_address",
                            ),
                            (
                                kaavish.payment.TransactionError("invalid_expiry_date"),
                                "invalid_expiry_date",
                            ),
                            (kaavish.payment.TransactionError("expired"), "expired"),
                            (
                                kaavish.payment.TransactionError("processing_error"),
                                "processing_error",
                            ),
                            (kaavish.payment.TransactionError("declined"), "declined"),
                        ],
                        max_length=256,
                        null=True,
                    ),
