    ...
    attributes = FilterInputConnectionField(
        ...
        in_category=graphene.Argument(
            ...
            description=(
                ...
                "DEPRECATED: Will be removed in kaavish 2.10, use the `filter` field "
                "instead."
            ),
        ),
        in_collection=graphene.Argument(
            ...
            description=(
                ...
                "DEPRECATED: Will be removed in kaavish 2.10, use the `filter` "
                "field instead."
            ),
        ),
    ...
    products = FilterInputConnectionField(
        ...
        attributes=graphene.List(
            ...
            description=(
                ...
                "kaavish 2.10, use the `filter` field instead."
            ),
        ),
