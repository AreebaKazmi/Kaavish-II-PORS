...
class CustomerRegister(ModelMutation):
    ...
    class Meta:
        description = (
            "DEPRECATED: Will be removed in kaavish 2.10, "
...
class LoggedUserUpdate(BaseCustomerCreate):
    ...
    class Meta:
        description = (
            "DEPRECATED: Will be removed in kaavish 2.10, use AccountUpdate instead."
...
class CustomerAddressCreate(ModelMutation):
    ...
    class Meta:
        description = (
            "DEPRECATED: Will be removed in kaavish 2.10, use AccountAddressCreate "
...
class CustomerSetDefaultAddress(BaseMutation):
    ...
    class Meta:
        description = (
            "DEPRECATED: Will be removed in kaavish 2.10, use AccountSetDefaultAddress "
...
class CustomerPasswordReset(BaseMutation):
    ...
    class Meta:
        description = (
            "DEPRECATED: Will be removed in kaavish 2.10, use RequestPasswordReset "
