...
unhandled_errors_logger = logging.getLogger("kaavish.graphql.errors.unhandled")
handled_errors_logger = logging.getLogger("kaavish.graphql.errors.handled")
    ...
    def get_response(self, request: HttpRequest, data: dict):
        ...
        if execution_result:
            ...
            if execution_result.errors:
                ...
                # Added code for Sentry integration - test with and without!!!
