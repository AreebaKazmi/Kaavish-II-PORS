...
import { KaavishProvider, useAuth, useUserDetails } from "@sdk/react";
...
// Sentry.init({dsn: "https://541cb5e751f04563aad9552986b2d3ed@sentry.io/1840118"});
      ...
      <Router history={history}>
        <QueryParamProvider ReactRouterRoute={Route}>
          <ApolloProvider client={apolloClient}>
            <KaavishProvider client={apolloClient}>
              <ShopProvider>
                <OverlayProvider>
                  <Checkout>
