...
class Fashion_attr_prediction(data.Dataset):
    ...
    def read_partition_category(self):
        ...
        # list_eval_partition = os.path.join(DATASET_BASE, r'Eval', r'list_eval_partition_eastern2.txt')
        # list_category_img = os.path.join(DATASET_BASE, r'Anno', r'list_category_img_eastern2.txt')

        list_eval_partition = os.path.join(DATASET_BASE, r'Eval', r'list_eval_partition_eastern+btd.txt')
        list_category_img = os.path.join(DATASET_BASE, r'Anno', r'list_category_img_eastern+btd.txt')
    ...
    def read_bbox(self, custom=False, scrapped=False):
        if custom:
            ...
            # list_bbox = os.path.join(DATASET_BASE, r'Anno', r'list_bbox_eastern2.txt')
            list_bbox = os.path.join(DATASET_BASE, r'Anno', r'list_bbox_eastern+btd.txt')
